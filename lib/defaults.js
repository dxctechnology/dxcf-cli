...
exports.system = process.env.DXCF_SYSTEM || ''; // Will search for a default in the merged Systems data if not set
exports.account = process.env.DXCF_ACCOUNT || ''; // Will search for a default in the merged Accounts data if not set
exports.environment = process.env.DXCF_ENVIRONMENT || ''; // Will search for a default in the merged Accounts data if not set
exports.region = process.env.DXCF_REGION || ''; // Will search for a default in the merged Regions data if not set
exports.user = process.env.DXCF_USER || ''; // Will search for a default in the merged Users data if not set
